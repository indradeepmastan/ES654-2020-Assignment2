...
class AdaBoostClassifier():
    def __init__(self, base_estimator, n_estimators=50, learning_rate=1.0):
        '''
        :param base_estimator: The base estimator from which the boosted ensemble is built (e.g., DecisionTree). If None, then the base estimator is DecisionTreeRegressor(max_depth=3).
